...
class EmergencyEditPage extends ConsumerStatefulWidget {
  const EmergencyEditPage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EmergencyEditPageState();
}
...
class _EmergencyEditPageState extends ConsumerState<EmergencyEditPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidgetWithTralling('Edit Contact', const Icon(Icons.check)),
      body: Padding(
